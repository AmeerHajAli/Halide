...
# export CXX="ccache c++"
export CXX="c++ -fopenmp -fno-omit-frame-pointer -g -ggdb"
...
APPS="local_laplacian" #bilateral_grid local_laplacian nl_means lens_blur camera_pipe stencil_chain harris hist max_filter unsharp interpolate conv_layer iir_blur bgu" # Missing mat_mul_generator and resnet_50_blockwise
